#### 11 July  2017 ####
#[17 July: adde mean case nuumbers]
rm(list = ls())
library(plyr)
library(dplyr)
library(ggplot2)
...
library(xtable)
### 
setwd("/Users/nhdne/Dropbox/ChangePointBin/Code/SimResults/Cox")
setwd("C:/Users/User/Dropbox/ChangePointBin/Code/SimResults/Cox")
###
...
all.results.cox <- matrix(nr = 21*1000, nc = 39) 
free <- 1  
j <- 0
